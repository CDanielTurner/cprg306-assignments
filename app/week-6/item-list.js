...
export default function ItemList({ itemsList }) {
  ...
  return (
    <div className="bg-slate-600 m-5 w-96 p-2">
      <div>
        <label>Sort by: </label>
        <button
          className="bg-blue-700   text-white font-bold py-2 rounded p-3 hover:bg-blue-700 items-center justify-center m-1 focus:bg-indigo-700"
          onClick={toggleSortName}
        >
          Name
        </button>
        <button
          className="bg-blue-300 text-white font-bold py-2 rounded p-3 hover:bg-indigo-700 items-center justify-center m-1 focus:bg-indigo-700"
